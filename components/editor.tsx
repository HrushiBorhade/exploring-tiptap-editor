...
"use client";
import { defaultEditorContent } from "@/lib/novel/default-content";
import {
  EditorCommand,
  EditorCommandEmpty,
  EditorCommandItem,
    ...
    <div className="relative w-full max-w-screen-lg">
      ...
      <EditorRoot>
        <EditorContent
          ...
          className="relative h-[70vh] overflow-auto w-full max-w-screen-lg border-muted bg-background sm:mb-[calc(20vh)] sm:rounded-lg sm:border sm:shadow-lg p-3"
          editorProps={{
            handleDOMEvents: {
